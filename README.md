...
before it happens. Anyone who can log a meeting can add one. Click **"Log
this meeting"** on a planned entry and it opens the real meeting form
pre-filled with the name, person type, phone if you gave one, and location
— finish the rest (Mode, Source, Result) and save as usual. The plan entry
marks itself Done the moment you do.

Same visibility as everywhere else: your own plan is yours, Team Lead sees
